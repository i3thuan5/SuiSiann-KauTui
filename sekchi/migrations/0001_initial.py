    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('音檔所在', models.FilePathField(match='.*.wav', max_length=200, path='/mnt/bfc3207f-8834-44cf-9206-3a13bda7bd35/home/fafofafoy/git/SuiSiann/SuiSiann-KauTui/汐止媠聲', recursive=True)),
                ('漢字', models.TextField()),
